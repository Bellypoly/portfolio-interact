...
import { registerPortraitOrientationLock } from "./registerPortraitOrientationLock.js";
import { usePortraitLandscapeVisible } from "./usePortraitLandscapeVisible.js";
  ...
  return (
    ...
    >
      ...
      <p className="portrait-landscape-gate__copy">
        This experience is designed for <strong>portrait</strong>. Please rotate your
        device upright to continue.
      </p>
    </SpaceVoidShell>
  );
}
