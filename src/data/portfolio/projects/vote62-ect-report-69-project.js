...
/** Shared case study fields; mission-gallery variants overlay keys from `vote62-ect-report-69/variants.js`. */
export const vote62EctReport69CaseStudyBase = {
  /* Header / intro */
...
export const vote62EctReport69Project = {
  ...
  caseStudy: { ...vote62EctReport69CaseStudyBase },
};
