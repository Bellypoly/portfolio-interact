...
export const peaEServiceCaseStudyVariants = Object.freeze({
  ...
  "data-reporter": Object.freeze({
    ...
    task:
      "Build public sector portals for civic data access — design user experiences for electricity and water services, integrating data flows for transparent government interactions.",
  }),
});
