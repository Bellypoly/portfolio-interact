...
export const articlePageRedesignCaseStudyVariants = Object.freeze({
  ...
  "data-reporter": Object.freeze({
    ...
    overviewSystemDesign: {
      ...
      diagram: [
        "Editorial system",
        "Arc XP CMS + PageBuilder",
        "↓",
        "Rendering layer",
        "React + JavaScript",
        "↓",
        "Single-column story surface",
        "↓",
        "Monetization",
        "GAM at content breakpoints",
        "↓",
        "Performance layer",
        "CLS stabilization · lazy loading · deferred assets",
        "↓",
        "Engagement + reader state",
        "Viafoura · regiwall · dynamic paywall · newsletter CTAs",
      ],
    ...
    problemSection: {
      ...
      paragraphs: [
        "The legacy experience fragmented attention and ownership at the same time: ads, recirculation, and engagement modules competed beside the story while layout shifts, reader-state branching, and monetization logic were distributed across disconnected template behavior.",
    ...
    FooterTagline:
      "Article stack after AMP: single-column story surface, lazy GAM orchestration, Viafoura engagement, paywall-aware reader-state branching, and GA4 · Datadog · BlueConic instrumentation.",
  }),
});
