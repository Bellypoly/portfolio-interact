...
export const localElectionsHubCaseStudyVariants = Object.freeze({
  ...
  "data-reporter": Object.freeze({
    eyebrow: "Data journalism · Data UI · Newsroom",
    task:
      "Build data-driven election hubs for civic platforms — integrate real-time results, visualizations, and analytics for newsroom reporting and public access.",
  }),
});
