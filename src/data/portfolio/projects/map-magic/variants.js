...
export const mapMagicCaseStudyVariants = Object.freeze({
  ...
  "data-reporter": Object.freeze({
    ...
    task: "Build geospatial platforms for civic data visualization — integrate proprietary maps, POI, and routing for newsroom analytics and public access to location-based information.",
  }),
});
