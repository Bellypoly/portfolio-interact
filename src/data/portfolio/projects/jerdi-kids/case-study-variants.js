...
export const jerdiKidsCaseStudyVariants = Object.freeze({
  ...
  "data-reporter": Object.freeze({
    ...
    task:
      "Design community safety platforms using QR and BLE for data collection and reporting — integrate with civic apps and newsroom tools for real-time alerts and analytics on missing persons.",
  }),
});
