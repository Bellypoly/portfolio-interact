  ...
  "data-reporter": Object.freeze({
    ...
    problemSection: {
      ...
      paragraphs: [
        ...
        "The captures below follow one outage across four layers you would recognize from a storm week: intake in eRespond, geography in PEA Map, live topology in ADMS, then ETR and planned-outage reporting in Power BI. Seen together, the integration boundary becomes clearer: what enters OMS, and what downstream systems read back out of it.",
      ],
      listGroups: [
        {
          title: "Into OMS",
    ...
    approach: [
      ...
      "Reproduced drift during weather and planned-outage peaks, then chased payloads, DAX, or warehouse fields until ETR and SAP-facing reads matched eRespond again\u2014same outage id, same operational truth.",
    ],
    relatedProject: {
      slug: "pea-e-service",
      label:
    ...
    results: [
      {
        value: "Single truth",
        label:
          "Canonical outage identity across OMS, GIS, SAP, ADMS, and reporting.",
      },
      {
        value: "Spatial data",
        label: "GIS→OMS ingestion pipelines aligned to authoritative exports.",
      },
      {
        value: "Ops visibility",
        label:
          "Warehouse-backed ETR and planned-outage reporting for reliability operations.",
      },
    ],
  }),
});
