...
export const federatedLearningEnergyCaseStudyVariants = Object.freeze({
  ...
  "data-reporter": Object.freeze({
    ...
    task:
      "Analyze energy consumption data from federated learning systems in wireless networks to inform civic platforms and newsroom reports on technology costs and efficiency.",
  }),
});
