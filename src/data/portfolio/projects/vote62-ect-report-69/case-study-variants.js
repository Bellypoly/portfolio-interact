...
export const vote62EctReport69CaseStudyVariants = Object.freeze({
  ...
  "data-reporter": Object.freeze({
    eyebrow: "Data journalism · OCR · ETL · Data Engineering · Data Storytelling",
    task:
      "Build OCR and ETL pipelines for election data — extract structured voting information from Thai reports for civic platforms and newsroom data storytelling.",
  }),
});
