...
export const photoCompetitionMyHometownCaseStudyVariants = Object.freeze({
  ...
  "data-reporter": Object.freeze({
    ...
    task:
      "Document cultural heritage through photography for civic platforms — create visual data stories and exhibits for community engagement and historical preservation.",
  }),
});
