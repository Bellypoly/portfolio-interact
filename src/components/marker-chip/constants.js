...
export const INTRO_MARKER_LABELS = {
  active: "Scroll to Begin Journey 🚀",
  inactive: "Launch Mission 🚀",
};

/** `aria-label` on the section marker `<nav>`. */
export const MARKER_NAV_ARIA_LABEL = "Jump to section";
