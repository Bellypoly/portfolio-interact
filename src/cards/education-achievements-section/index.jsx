...
const ACHIEVEMENT_ITEMS = [
  {
    ...
    meta: "2019 - Present • Texas Tech University, USA",
  },
  {
    type: "achievement",
    sortYear: 2017,
    title: "Recipient of Petchra Prajomklao Graduate Scholarship",
    meta: "2015 - 2017 • KMUTT, Bangkok, Thailand",
  },
  {
    type: "achievement",
    sortYear: 2018,
  ...
  },
  {
    ...
    meta: "2014 • Bangkok, Thailand",
  },
];

// Merge and sort by time (most recent first)
const TIMELINE_ITEMS = [...EDUCATION_ITEMS, ...ACHIEVEMENT_ITEMS].sort(
  (a, b) => b.sortYear - a.sortYear,
);

export default function EducationAchievementsSection({ sectionProgress }) {
  ...
  return (
    <motion.div className="edu-achievements-section" style={{ opacity }}>
      <div className="edu-achievements-title-row">
        <h2 className="section-title edu-achievements-title">
      ...
      <div className="edu-timeline">
        ...
        {TIMELINE_ITEMS.map((item, i) => (
          <div
            key={i}
            className={`edu-timeline__entry edu-timeline__entry--${item.type}`}
          >
            ...
            <div className="edu-timeline__content">
              {item.type === "education" ? (
                ...
                <div className="edu-timeline__achievement">
                  <strong>{item.title}</strong>
                  <div className="edu-achievements-meta">{item.meta}</div>
                </div>
              )}
            </div>
          </div>
